...
DO $$
begin
RAISE NOTICE '...Creating trip_stops';
...
INSERT INTO trip_stops (trip_id, stop_sequence, num_stops, route_id, service_id,
...
SET perc = CASE
	...
	ELSE ST_LineLocatePoint(traj, stop_loc)
END
...
RAISE NOTICE '...Creating trip_segs';
...
SET seg_geom =
   (CASE WHEN perc1 > perc2 THEN seg_geom
    ELSE ST_LineSubstring(traj, perc1, perc2)
    END)
FROM trajectories g
WHERE t.shape_id = g.shape_id;
...
RAISE NOTICE '...Creating trip_points';
...
RAISE NOTICE '...Creating trip_input';
...
RAISE NOTICE '...Creating trip_mdb';
